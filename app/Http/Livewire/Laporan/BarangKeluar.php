...
class BarangKeluar extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.laporan.barang-keluar', compact('data', 'users', 'barangs'))
            ->extends('layouts.apps', ['title' => 'Laporan Inventory - Barang Keluar']);
    }
    ...
    public function exportPDF($id_user, $id_barang, $dari_tanggal, $sampai_tanggal)
    {
        ...
        return view('livewire.pdf.barang-keluar', ['data' => $data, 'no' => 1, 'dari_tanggal' => $dari_tanggal, 'sampai_tanggal' => $sampai_tanggal]);
    }
}
