<div>
    <section class="section">
        <div class="section-header tw-rounded-none lg:tw-rounded-lg tw-shadow-md tw-shadow-gray-300 px-4">
            <h1 class="tw-text-lg mb-1">Laporan Daftar Customer</h1>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tw-flex tw-mt-4 tw-ml-auto">
                                <a href="{{ route('laporan-excel.daftar-customer') }}" target="_BLANK"
                                    class="btn btn-success">
                                    <i class="far fa-file-excel"></i> Export Excel
                                </a>
                                <a href="{{ route('laporan-pdf.daftar-customer') }}" target="_BLANK"
