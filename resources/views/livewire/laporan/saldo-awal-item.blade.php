<div>
    <section class="section">
        <div class="section-header tw-rounded-none lg:tw-rounded-lg tw-shadow-md tw-shadow-gray-300 px-4">
            <h1 class="tw-text-lg mb-1">Laporan Saldo Awal Barang</h1>
        </div>
                    ...
                    <div class="card tw-shadow-md tw-shadow-gray-300 tw-rounded-lg">
                        <div class="card-body">
                            ...
                            <div class="tw-grid tw-grid-cols-2 tw-gap tw-gap-3">
                                <div>
                                    <a href="{{ route('laporan-excel.saldo-awal', ["id_user" => $this->id_user, "id_barang"=> $this->id_barang,
                                ...
                                <div>
                                    <a href="{{ route('laporan-pdf.saldo-awal', ["id_user" => $this->id_user, "id_barang"=> $this->id_barang,
                                    "dari_tanggal" => $this->dari_tanggal, "sampai_tanggal" =>
                    ...
                    <div class="activities">
                        ...
                        <div class="activity">
                            ...
                            <div class="activity-detail tw-rounded-lg tw-shadow-md tw-shadow-gray-300">
                                ...
                                <p>Menambahkan saldo awal barang: <b
                                        class="tw-text-gray-900">{{ $row->nama_barang }}</b>
                                    sebanyak <b class="tw-text-gray-900">{{ $row->qty }}</b> pcs</p><br />
