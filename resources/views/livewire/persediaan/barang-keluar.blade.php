<div>
    <section class="section">
        <div class="section-header tw-rounded-none lg:tw-rounded-lg tw-shadow-md tw-shadow-gray-300 px-4">
            <h1 class="tw-text-lg mb-1">Persediaan - Stok Keluar</h1>
        </div>
                    ...
                    <div class="card tw-rounded-md tw-shadow-md">
                        <div class="card-body">
                            ...
                            <div class="tw-grid tw-grid-cols-2 tw-gap tw-gap-3">
                                <div>
                                    <a href="{{ route('laporan-excel.barang-keluar', ["id_user" => $this->id_user, "id_barang"=> $this->filter_id_barang,
                                ...
                                <div>
                                    <a href="{{ route('laporan-pdf.barang-keluar', ["id_user" => $this->id_user, "id_barang"=> $this->filter_id_barang,
                                    "dari_tanggal" => $this->filter_dari_tanggal, "sampai_tanggal" =>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="qty_barang" class="form-control text-center tw-rounded-lg"
                                        value="{{ $qty_barang }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="qty">Qty</label>
                                    <input type="text" wire:model='qty' name="qty" id="qty"
                                        class="form-control text-center tw-rounded-lg">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
